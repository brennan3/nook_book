variable "name" { default = "mnesia2c" }
variable "nookbook_vpc_id" { default = "vpc-0dc86c5a01fcfc699" }
variable "nookbook_alb_listener" { default = "arn:aws:elasticloadbalancing:us-east-2:797420293962:listener/app/app-alb/06ba40177a02a85d/8970cd65f589522b" }
...
resource "aws_security_group" "nookbook" {
  ...
  ingress {
    ...
    description = "EPMD post connect mappings"
  }
